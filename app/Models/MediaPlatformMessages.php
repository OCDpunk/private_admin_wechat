...
class MediaPlatformMessages extends Model
{
    ...
    protected $fillable = ['media_platform_code', 'media_platform_name', 'to_user_name', 'from_user_name', 'create_time', 'msg_type', 'msg_id', 'content', 'media_id',
     ...
     * @return void
     */
    public function setOriginalDataAttribute($value)
    {
        $this->attributes['original_data'] = json_encode($value);
    }
